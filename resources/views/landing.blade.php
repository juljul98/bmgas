...
@section('content')
        ...
        <!--=================================  HEADER START ==========================================-->
        <div class="header-image clearfix" id="home">           
            <div class="header-section">
                <div class="container notifyModal">
                    <div class="col-sm-12 header-div text-center">                      
                        <h1>Save the Kindness</h1>
                        <p>Donec varius sodales orci. Class aptent taciti sociosqu torquent, per inceptos himenaeos.  Aenean arcu viverra varius sodales..</p>
                        <a href="#fadeandscale" class="btn header-btn fadeandscale_open">Donate Now</a>
                    </div>          
                </div>
            </div>  
        </div>
        ...
        <section class="section-padding section-1-bg">
            <div class="container">
                <div class="heading-div text-center">
                    <h2>Various Causes</h2>
                    <img src="images/90x10x1.png" alt="90x10" />
                </div>
                <div class="row">
                    <div class="col-sm-4 text-center various-col">
                        <a href="#"><img src="images/64x64x1.png" alt="64x64x1" /></a>
                        <h3>Poverty</h3>
                        <p>
                        ...
                        <div class="progress-div">
                            <p class="progress-value text-right">(51%)</p>
                    ...
                    <div class="col-sm-4 text-center responsive-top-space various-col">
                        <a href="#"><img src="images/64x64x2.png" alt="64x64x2" /></a>
                        <h3>Drought</h3>
                        <p>
                            Donec varius sodales orci. Class aptent taciti sociosqu torquent, per inceptos himenaeos. End of content.
                            Aenean arcu viverra varius sodales sociosqu torquent, per inceptos himenaeos.
                    ...
                    <div class="col-sm-4 text-center responsive-top-space various-col">
                        <a href="#"><img src="images/64x64x3.png" alt="64x64x3" /></a>
                        <h3>Education</h3>
                        <p>
                            Donec varius sodales orci. Class aptent taciti sociosqu torquent, per inceptos himenaeos. End of content.
                            Aenean arcu viverra varius sodales sociosqu torquent, per inceptos himenaeos.
                ...
                <div class="row no-row">
                    ...
                    <div class="col-sm-6 who-care-col">
                        <div class="heading-div-1">
                            ...
                            <h2>Who We Care</h2>
                            <img src="images/100x3.png" alt="100x3" />
                        </div>
            ...
            <div class="container">
                ...
                <div class="row help-reduce-div">
                    <div class="col-sm-6 help-reduce-col">
                        <div class="row help-reduce-row-1 help-reduce-row-2 help-reduce-space">
                            <div class="col-xs-2 col-sm-2">
                                <a href="#"><img src="images/64x64x4.png" alt="64x64x4" /></a>
                            </div>
                        ...
                        <div class="row help-reduce-row-1 help-reduce-row-2 help-reduce-space">
                            <div class="col-xs-2 col-sm-2">
                                <a href="#"><img src="images/64x64x5.png" alt="64x64x5" /></a>
                            </div>
                            <div class="col-xs-10 col-sm-9 col-md-10">
                                <h3>Drought</h3>
                                <p>
                        ...
                        <div class="row help-reduce-row-1 help-reduce-row-3 help-reduce-space">
                            <div class="col-xs-2 col-sm-2">
                                <a href="#"><img src="images/64x64x6.png" alt="64x64x6" /></a>
                            </div>
                            <div class="col-xs-10 col-sm-9 col-md-10">
                                <h3>Child Labour</h3>
                                <p>
                    ...
                    <div class="col-sm-6 help-reduce-col">
                        <div class="row help-reduce-row-1 help-reduce-row-2 help-reduce-space">
                            <div class="col-xs-2 col-sm-2">
                                <a href="#"><img src="images/64x64x7.png" alt="64x64x7" /></a>
                            </div>
                            <div class="col-xs-10 col-sm-9 col-md-10">
                                <h3>Poverty</h3>
                                <p>
                        ...
                        <div class="row help-reduce-row-1 help-reduce-row-2 help-reduce-space">
                            <div class="col-xs-2 col-sm-2">
                                <a href="#"><img src="images/64x64x8.png" alt="64x64x8" /></a>
                            </div>
                            <div class="col-xs-10 col-sm-9 col-md-10">
                                <h3>Infanticide</h3>
                                <p>
                        ...
                        <div class="row help-reduce-row-1">
                            <div class="col-xs-2 col-sm-2">
                                <a href="#"><img src="images/64x64x9.png" alt="64x64x9" /></a>
                            </div>
                            <div class="col-xs-10 col-sm-9 col-md-10">
                                <h3>War Violence</h3>
                                <p>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-4 camps-done-col">
                        <img src="images/360x250x1.jpg" alt="360x250x1" class="img-responsive" />
                    ...
                    <div class="col-sm-4 camps-done-col responsive-top-space ">
                        <img src="images/360x250x2.jpg" alt="360x250x2" class="img-responsive"/>
                    ...
                    <div class="col-sm-4 camps-done-col responsive-top-space ">
                        <img src="images/360x250x3.jpg" alt="360x250x3" class="img-responsive"/>
        ...
        <section class="section-padding section-4-bg" id="donators">
            <div class="container">
                <div class="heading-div-2 text-center">
                    ...
                    <img src="images/90x10x2.png" alt="90x10x2" />
                </div>
                <div class="row donators-details">
                    <div class="col-xs-4 col-sm-4">
                        <ul>
                            <li><img src="images/16x16x1.png" alt="16x16x1" /></li>
                            <li><p>Tue-8.00 am</p></li>
                        </ul>
                    </div>
                    <div class="col-xs-4 col-sm-4">
                        <ul>
                            <li><img src="images/16x16x2.png" alt="16x16x1" /></li>
                            <li><p>Nov 20, 2016</p></li>
                        </ul>
                    </div>
                    <div class="col-xs-4 col-sm-4">
                        <ul>
                            <li><img src="images/16x16x3.png" alt="16x16x1" /></li>
                ...
                <div class="row donators-profile">
                     <div class="col-xs-6 col-sm-6 col-md-3">
                        <div class="donators-profile-col text-center">
                            <img src="images/150x150x1.png" alt="150x150x1" />
                            <p>Name</p>
                        </div>
                    </div>
                    <div class="col-xs-6 col-sm-6 col-md-3 donator-top-space-1">
                        <div class="donators-profile-col text-center">
                            <img src="images/150x150x2.png" alt="150x150x2" />
                            <p>Name</p>
                        </div>
                    </div>
                    <div class="col-xs-6 col-sm-6 col-md-3 donator-top-space">
                        <div class="donators-profile-col text-center">
                            <img src="images/150x150x3.png" alt="150x150x3" />
                            <p>Name</p>
                        </div>
                    </div>
                    <div class="col-xs-6 col-sm-6 col-md-3 donator-top-space">
                        <div class="donators-profile-col text-center">
                            <img src="images/150x150x4.png" alt="150x150x4" />
                            <p>Name</p>
                        </div>
                    </div>
                </div>  
        ...
        <section class="section-padding section-1-bg">
            <div class="container">
                <div class="heading-div text-center">
                    ...
                    <img src="images/90x10x1.png" alt="90x10x1" />
                </div>
                <div class="row">                   
                    <div class="col-sm-4 involvements-col">
                        <img src="images/360x250x4.jpg" alt="360x250x4" class="img-responsive"/>
                    ...
                    <div class="col-sm-4 involvements-col responsive-top-space">
                        <img src="images/360x250x5.jpg" alt="360x250x5" class="img-responsive"/>
                    ...
                    <div class="col-sm-4 involvements-col responsive-top-space">
                        <img src="images/360x250x6.jpg" alt="360x250x6" class="img-responsive" />
                        <h3>Education Camp For Poor</h3>
                        <p>
                            Donec varius sodales orci. Class aptent taciti sociosqu torquent, per inceptos himenaeos. End of content.
                            Aenean arcu viverra varius sodales sociosqu torquent, per inceptos himenaeos.
            ...
            <div class="container">
                ...
                <div class="row gallery-div">
                    <div class="col-sm-4 col-xs-6 bottom-space">
                        <img src="images/360x360x1.jpg" alt="360x360x1" class="img-responsive" />
                    </div>                  
                    
                    <div class="col-sm-4 col-xs-6 bottom-space">
                        <img src="images/360x360x2.jpg" alt="360x360x2" class="img-responsive" />
                    </div>  
                    
                    <div class="col-sm-4 col-xs-6 bottom-space">
                        <img src="images/360x360x3.jpg" alt="360x360x3" class="img-responsive" />
                    </div>                  
                
                    <div class="col-sm-4 col-xs-6 gallery-img">
                        <img src="images/360x360x4.jpg" alt="360x360x4" class="img-responsive" />
                    </div>                  
                    
                    <div class="col-sm-4 col-xs-6 gallery-img">
                        <img src="images/360x360x5.jpg" alt="360x360x5" class="img-responsive" />
                    </div>  
                    
                    <div class="col-sm-4 col-xs-6">
                        <img src="images/360x360x6.jpg" alt="360x360x6" class="img-responsive" />
                    </div>                      
                </div>
            </div>          
        </section>      
            ...
            <div class="container">
                ...
                <div class="row news-main-row">
                    <div class="col-sm-6">
                        <div class="row news-row news-space">
                            <div class="col-xs-1 col-sm-2">
                                <img src="images/48x48x1.png" alt="48x48x1" />
                            </div>
                        ...
                        <div class="row news-row news-row-1 news-space">
                            <div class="col-xs-1 col-sm-2">
                                <img src="images/48x48x2.png" alt="48x48x2" />
                            </div>
                            <div class="col-xs-10 col-sm-10">
                                <h3>Best Complementary</h3>
                                <p class="news-date"><a href="#">Feb 01, 2017</a></p>
                    ...
                    <div class="col-sm-6 news-second-col">
                        <div class="row news-row news-space">
                            <div class="col-xs-1 col-sm-2">
                                <img src="images/48x48x3.png" alt="48x48x3" />
                            </div>
                            <div class="col-xs-10 col-sm-10">
                                <h3>Best Complementary</h3>
                                <p class="news-date"><a href="#">Feb 01, 2017</a></p>
                        ...
                        <div class="row news-row news-row-1">
                            <div class="col-xs-1 col-sm-2">
                                <img src="images/48x48x4.png" alt="48x48x4" />
                            </div>
                            <div class="col-xs-10 col-sm-10">
                                <h3>Best Complementary</h3>
                                <p class="news-date"><a href="#">Feb 01, 2017</a></p>
        ...
        <section class="section-padding section-1-bg">
            <div class="container">
                ...
                <div class="row volunteers-row-1">
                    <div class="col-sm-6">
                        <img src="images/590x250x2.jpg" alt="590x250x2" class="img-responsive" />
                    </div>
                ...
                <div class="row volunteers-row-2">
                    <div class="col-sm-6 col-sm-push-6">
                        <img src="images/590x250x3.jpg" alt="590x250x3" class="img-responsive" />
                    </div>
        ...
        <section class="section-padding section-2-bg">
            <div class="container">
                ...
                <div class="col-sm-12 best-moment">
                    <img src="images/1000x400.jpg" alt="1000x400" class="img-responsive" />         
                </div>                              
            </div>          
        </section>      
            ...
            <div class="container">
                ...
                <div class="row events-row-1">
                    <div class="col-sm-6 events-img">
                        <img src="images/590x280x1.jpg" alt="590x280x1" class="img-responsive" />
                    </div>
                    <div class="col-sm-6 events-col">
                        ...
                        <div class="col-sm-12 events-date-div">
                            <div class="col-sm-6">
                                <ul>
                                    <li><a href="#"><img src="images/16x16x4.png" alt="16x16x4" /></a></li>
                                    <li> Montreal, Qc.</li>
                                </ul>
                            </div>  
                            <div class="col-sm-6">                          
                                <ul>
                                    <li><a href="#"><img src="images/16x16x5.png" alt="16x16x5" /></a></li>
                ...
                <div class="row events-second-row">
                    <div class="col-sm-6 events-img">
                        <img src="images/590x280x2.jpg" alt="590x280x2" class="img-responsive" />
                    </div>
                    <div class="col-sm-6 events-col">
            ...
            <div class="container">
                ...
                <div class="col-sm-12">                 
                    <div class="testimonial-div text-center">                       
                        <img src="images/100x100x1.png" alt="100x100x1"/>
                        <p> "Aenean arcu viverra varius sodales sociosqu torquent, per inceptos himenaeos.Donec varius sodales orci.
                        Class aptent taciti sociosqu torquent, per inceptos himenaeos. End of content."
                        </p>
            ...
            <div class="container">
                ...
                <div class="row moving-row">                    
                    <div class="col-sm-6 col-md-3 text-center moving-col moving-col-1">
                        <a href="#" class="bottom-space"><img src="images/80x80x1.png" alt="80x80x1" /></a>
                        <h3>Kindness</h3>
                    ...
                    <div class="col-sm-6 col-md-3 text-center moving-col moving-col-2 ">
                        <a href="#" class="bottom-space"><img src="images/80x80x2.png" alt="80x80x2" /></a>
                        <h3>Dedication</h3>
                        <p>Aenean arcu viverra varius sodales sociosqu torquent, per inceptos himenaeos.Donec varius sodales orci.</p>
                    </div>
                    <div class="col-sm-6 col-md-3 text-center moving-col moving-col-1 moving-4">
                        <a href="#" class="bottom-space"><img src="images/80x80x3.png" alt="80x80x3" /></a>
                        <h3>Kindness</h3>
                        <p>Aenean arcu viverra varius sodales sociosqu torquent, per inceptos himenaeos.Donec varius sodales orci.</p>
                    </div>
                    <div class="col-sm-6 col-md-3 text-center moving-col moving-col-2 moving-3">
                        <a href="#" class="bottom-space"><img src="images/80x80x4.png" alt="80x80x4" /></a>
                        <h3>Kindness</h3>
                        <p>Aenean arcu viverra varius sodales sociosqu torquent, per inceptos himenaeos.Donec varius sodales orci.</p>
                    </div>
                </div>              
            ...
            <div class="container">                         
                <div class="row">                   
                    <div class="col-sm-6 wonderful-img">
                        <img src="images/590x280x3.jpg" alt="590x280x3"  class="img-responsive"/>
                    </div>
            ...
            <div class="container">                         
                <div class="row">                   
                    <div class="col-sm-6 col-sm-push-6 happiest-img">
                        <img src="images/590x280x4.jpg" alt="590x280x4"  class="img-responsive"/>
                    </div>
            ...
            <div class="container">                         
                ...
                <div class="row sponsors-row">                  
                    <div class="col-xs-6 col-sm-4 col-md-2 sponsors-space-1">
                        <img src="images/180x120x1.png" alt="180x120x1" class="img-responsive"/>    
                    </div>
                    <div class="col-xs-6 col-sm-4 col-md-2 sponsors-space-1">
                        <img src="images/180x120x2.png" alt="180x120x2" class="img-responsive"/>    
                    </div>
                    <div class="col-xs-6 col-sm-4 col-md-2 sponsors-space sponsors-space-1">
                        <img src="images/180x120x3.png" alt="180x120x3" class="img-responsive"/>    
                    </div>
                    <div class="col-xs-6 col-sm-4 col-md-2 sponsors-space sponsors-space-1 sponsors-space-2">
                        <img src="images/180x120x4.png" alt="180x120x4" class="img-responsive"/>    
                    </div>
                    <div class="col-xs-6 col-sm-4 col-md-2 sponsors-space-1 sponsors-space-2">
                        <img src="images/180x120x5.png" alt="180x120x5" class="img-responsive"/>    
                    </div>
                    <div class="col-xs-6 col-sm-4 col-md-2 sponsors-space-2">
                        <img src="images/180x120x6.png" alt="180x120x6" class="img-responsive"/>    
                    </div>
                </div>  
            </div>          
        </section>      
        ...
        <div class="section-2-bg">
            <div class="container"> 
                <img src="images/1500x600.jpg" alt="1500x600" class="img-responsive" />             
            </div>          
        </div>      
                    ...
                    <div class="col-sm-12">
                        <div class="row contact-row">
                            <div class="col-xs-6 col-sm-3 contact-space contact-space-1">
                                <img src="images/48x48x5.png" alt="48x48x5" />
                                <p>1800-234-7689</p>
                            </div>
                            <div class="col-xs-6 col-sm-3 contact-space contact-space-1">
                                <img src="images/48x48x6.png" alt="48x48x6" />
                                <p>info@charity.com</p>
                            </div>
                            <div class="col-xs-6  col-sm-3 contact-space">
                                <img src="images/48x48x7.png" alt="48x48x7" />
                                <p>Mon-Sat:8.00-18.00</p>
                            </div>
                            <div class="col-xs-6 col-sm-3">
                                <img src="images/48x48x8.png" alt="48x48x8" />
                                <p>+012 654 8790</p>
                            </div>
                        </div>
                        ...
                        <ul>
                            <li>
                                <a href="#"><img src="images/48x48x9.png" alt="48x48x9" class="img-responsive" /></a>
                            </li>
                            <li>
                                <a href="#"><img src="images/48x48x10.png" alt="48x48x10" class="img-responsive" /></a>
                            </li>
                            <li>
                                <a href="#"><img src="images/48x48x11.png" alt="48x48x11" class="img-responsive" /></a>
                            </li>
                            <li>
                                <a href="#"><img src="images/48x48x12.png" alt="48x48x12" class="img-responsive" /></a>
                            </li>
                            <li>
                                <a href="#"><img src="images/48x48x13.png" alt="48x48x13"  class="img-responsive" /></a>
                            </li>
                        </ul>
                        <div class="separator"></div>
                        <div class="copyright">
            ...
            <div>   
                ...
                <form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="POST" class="popup-form" id="popup-form">
                    ...
                    <div class="row">
                        ...
                        <input type="hidden" name="return" value="demo-1b81f.html?success=true">                    
                        <input type="hidden" name="cancel_return" value="demo-1142a.html?cancel=true">
